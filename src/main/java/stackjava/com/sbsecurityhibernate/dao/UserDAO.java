...
public class UserDAO {
	...
	public List<SaleMerch> getAllSaleMerch(String dayFrom,String dayto,String username ) {
		try {
			...
			Session session = this.sessionFactory.getCurrentSession();
			users = session.createNativeQuery("select * from sale_merch where  username=:username and :dayFrom <= day and day <= :dayto order by name ASC, sale desc , ip ASC ", SaleMerch.class)
